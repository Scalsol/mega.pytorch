...
from mega_core.utils.comm import get_world_size
from mega_core.utils.imports import import_file
from mega_core.utils.miscellaneous import save_labels
...
def make_data_loader(cfg, is_train=True, is_distributed=False, start_iter=0, is_for_period=False):
    ...
    paths_catalog = import_file(
        "mega_core.config.paths_catalog", cfg.PATHS_CATALOG, True
    )
    ...
    for dataset in datasets:
        ...
        collator = BBoxAugCollator() if not is_train and cfg.TEST.BBOX_AUG.ENABLED else \
            BatchCollator(cfg.DATALOADER.SIZE_DIVISIBILITY, cfg.MODEL.VID.METHOD, is_train)
